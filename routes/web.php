...
Route::get('/debug-laravel', function () {
    return response()->json([
        ...
        'flag_exists'   => file_exists(storage_path('app/database_created')),
        'resource_path' => resource_path('views'),
        'view_file'     => file_exists(resource_path('views/app.blade.php')),
    ]);
});
Route::get('/debug-project', function () {
    return response()->json([
        ...
        'storage_app'  => file_exists(base_path('storage/app/database_created')),
        'view_exists'  => file_exists(base_path('resources/views/app.blade.php')),
...
Route::get('/create-storage-link', function () {
    try {
        ...
        return Response::make('✔ Storage link creado', 200);
    } catch (\Exception $e) {
        return Response::make('✘ Error al crear storage link: '.$e->getMessage(), 500);
    }
});
