...
use Crater\Http\Controllers\V1\Admin\Verifactu\DashboardController as VerifactuDashboardController;
use Crater\Http\Controllers\V1\Admin\Verifactu\ListEventsController as VerifactuListEventsController;
use Crater\Http\Controllers\V1\Admin\Verifactu\ListRecordsController as VerifactuListRecordsController;
use Crater\Http\Controllers\V1\Admin\Verifactu\ListSubmissionsController as VerifactuListSubmissionsController;
use Crater\Http\Controllers\V1\Admin\Verifactu\RetrySubmissionController as VerifactuRetrySubmissionController;
use Crater\Http\Controllers\V1\Admin\Verifactu\ShowDeclarationController as VerifactuShowDeclarationController;
use Crater\Http\Controllers\V1\Admin\Verifactu\ShowEventController as VerifactuShowEventController;
...
use Crater\Http\Controllers\V1\Admin\Verifactu\CreateDeclarationController as VerifactuCreateDeclarationController;
use Crater\Http\Controllers\V1\Admin\Verifactu\UpdateDeclarationController as VerifactuUpdateDeclarationController;
...
Route::prefix('/v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'company'])->group(function () {
        Route::middleware(['bouncer'])->group(function () {
            ...
            Route::get('/verifactu/dashboard', VerifactuDashboardController::class);
            Route::get('/verifactu/records', VerifactuListRecordsController::class);
            ...
            Route::get('/verifactu/declarations/{declaration}', VerifactuShowDeclarationController::class);
            ...
            Route::post('/invoices/{invoice}/rectify', CreateRectificativeInvoiceController::class);
