...
<body>
        ...
        <table width="100%">
            <tr>
                <td width="60%" style="vertical-align: top;">
                    @if ($logo)
                        <img class="header-logo" style="height: 110px;" src="{{ $logo }}" alt="Company Logo">
                    @else
                ...
                <td class="header-right">
                    <div class="invoice-badge">@lang('pdf_invoice_label')</div>
    ...
    <hr style="border: 1px solid #F0F0F0; margin: 5px 30px;">
                    ...
                    <tr>
                        <td width="55%" style="vertical-align: top;">
                            ...
                            @if ($shipping_address && $shipping_address !== '</br>')
                                <div style="margin-top: 15px;" class="shipping-address">
