...
// VERI*FACTU
const VerifactuIndex = () =>
  import('@/scripts/admin/views/verifactu/Index.vue')
const VerifactuRecordsIndex = () =>
  import('@/scripts/admin/views/verifactu/RecordsIndex.vue')
const VerifactuSubmissionsIndex = () =>
  import('@/scripts/admin/views/verifactu/SubmissionsIndex.vue')
const VerifactuEventsIndex = () =>
  import('@/scripts/admin/views/verifactu/EventsIndex.vue')
const VerifactuSetupView = () =>
  import('@/scripts/admin/views/verifactu/SetupView.vue')
const VerifactuRecordView = () =>
  import('@/scripts/admin/views/verifactu/RecordView.vue')
const VerifactuSubmissionView = () =>
  import('@/scripts/admin/views/verifactu/SubmissionView.vue')
const VerifactuEventView = () =>
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: VerifactuIndex,
      },
      {
        path: 'verifactu/records',
        name: 'verifactu.records.index',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuRecordsIndex,
      },
      {
        path: 'verifactu/submissions',
        name: 'verifactu.submissions.index',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuSubmissionsIndex,
      },
      {
        path: 'verifactu/events',
        name: 'verifactu.events.index',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuEventsIndex,
      },
      {
        path: 'verifactu/setup',
        name: 'verifactu.setup.view',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuSetupView,
      },
      {
        path: 'verifactu/records/:id/view',
        name: 'verifactu.records.view',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuRecordView,
      },
      {
        path: 'verifactu/submissions/:id/view',
        name: 'verifactu.submissions.view',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuSubmissionView,
      },
      {
        path: 'verifactu/events/:id/view',
        name: 'verifactu.events.view',
        meta: { ability: abilities.VIEW_VERIFACTU },
        component: VerifactuEventView,
      },
      {
        path: 'verifactu/declarations/:id/view',
