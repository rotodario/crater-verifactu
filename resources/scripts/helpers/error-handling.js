...
export const showError = (error) => {
  switch (error) {
    ...
    case 'invoice_fiscally_locked':
      showToaster('Fiscally issued invoices cannot be edited or deleted.', false)
      break

    case 'invoice_must_be_fiscally_issued':
      showToaster('Only fiscally issued invoices can be rectified.', false)
      break

    case 'rectificative_invoice_cannot_be_rectified':
      showToaster('Rectificative invoices cannot be rectified again with the current flow.', false)
      break

    case 'rectification_type_not_supported':
      showToaster('Difference rectifications are not supported yet in this installation.', false)
      break

    case 'draft_rectificative_already_exists':
      showToaster('A draft rectificative invoice already exists for this invoice.', false)
      break

    case 'verifactu_submission_retry_not_allowed':
      showToaster('Only failed VERI*FACTU submissions can be retried.', false)
      break
