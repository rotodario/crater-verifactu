...
Esta copia contiene una implementaci?n en curso de VERI*FACTU sobre una instalaci?n real restaurada.

- Resumen del fork: [README-fork-verifactu.md](README-fork-verifactu.md)
